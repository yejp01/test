...
public class Test {
	...
	private static void getRealtimeQuotes() {
		...
		String requestXml = "<?xml version='1.0' encoding='UTF-8'?><Request><portNo>FSK</portNo>"
				...
				+ "<isInsurance>1</isInsurance><insuranceAmount>100000</insuranceAmount><customerTransportTypeInfo>公路快件</customerTransportTypeInfo>"
				+ "<deliveryProvince>北京市</deliveryProvince><deliveryCity>北京市</deliveryCity><receiverProvince>天津市</receiverProvince>"
				+ "<receiverCity>天津市</receiverCity><receiverArea>开发区</receiverArea></Request>";
		// Wsdl地址
		// String endpoint =
